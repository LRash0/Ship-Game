# O módulo permite renderizar o texto na tela
import pygame.font
...
class Button():
	...
	def prep_msg(self,msg):
		"""Transforma msg em imagem renderizada e centraliza o text no botão."""
	...
	def draw_button(self):
		"""Deseha um botão em branco e,em seguida,desenha a mensagem."""
